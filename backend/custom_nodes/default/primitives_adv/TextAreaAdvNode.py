...
class TextAreaAdvNode(CustomNode):
    def __init__(self, _engine: FlowEngine, _id: str, _nodetype: str):
        super().__init__(_engine, _id, _nodetype, "TextArea (Advanced)")
    ...
    @staticmethod
    def route() -> str:
        return "primitives_adv/textarea"
    ...
    async def set_value(self, value):
        ...
        if isinstance(value, str):
            ...
            print(f"ERROR: Invalid value type for TextAreaAdvNode. Expected string, got {type(value)}")
